...
module.exports = Application = (function() {
  ...
  Application.prototype.switch_locale = function(locale, options) {
    ...
    return $.get("/data/translations/" + locale + "/messages.json", function(locale_data) {
      var gettext;
      gettext = new Gettext({
        domain: 'messages',
...
module.exports = ConceptDB = (function(_super) {
  ...
  ConceptDB.prototype.url = "/data/concepts.json";
...
module.exports = QuestionDB = (function(_super) {
  ...
  QuestionDB.prototype.url = "/data/leksa_questions.json";
